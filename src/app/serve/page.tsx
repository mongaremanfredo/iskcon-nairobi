...
export default function ServePage() {
  return (
    <>
      <PageHero title="Serve the" titleAccent="Community" subtitle="Volunteer Opportunities" description="Join hundreds of dedicated volunteers whose selfless service sustains ISKCON Nairobi's programmes across Kenya." image="/images/placeholders/iskcon-temple-bangalore.jpg" contentClassName="sm:!pb-5" />
