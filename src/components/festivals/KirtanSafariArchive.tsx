    ...
    <main className="ks-archive">
      ...
      <section className="ks-archive-story">
        <div className="content-width section-padding">
          ...
          <section className="ks-archive-guests" aria-labelledby="ks-archive-guests-title">
            <div>
              <p>Guest kirtaniyas</p>
              <h2 id="ks-archive-guests-title">The Voices of the 2026 Gathering</h2>
            </div>
            <div className="ks-archive-guest-grid">
              {kirtanSafariGuestKirtaniyas.map((guest) => (
                <article key={guest.name}>
                  <Image
                    src={guest.image}
                    alt={`${guest.name}, Kirtan Safari 2026 guest kirtaniya`}
                    width={420}
                    height={525}
