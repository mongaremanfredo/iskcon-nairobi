...
export default function WhatsAppWidget() {
  ...
  return (
    ...
    >
      ...
      <span className="relative flex h-14 w-14 items-center justify-center rounded-full border border-gold/25 bg-dusk text-[#25D366] shadow-card transition-all duration-300 group-hover:scale-105 group-hover:border-gold/50 group-hover:shadow-card-hover max-[900px]:h-12 max-[900px]:w-12">
        <svg viewBox="0 0 24 24" className="h-7 w-7 max-[900px]:h-6 max-[900px]:w-6" fill="currentColor" aria-hidden="true">
